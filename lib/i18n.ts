    ...
    translation: {
      ...
      admin: {
        ...
        dashboard: {
          ...
          userActivity: 'Active users in last 30 days',
        ...
        settings: {
          ...
          api: {
            title: 'API Settings',
            description: 'Configure API related parameters',
            openaiKey: 'OpenAI API Key',
            rateLimit: 'API Rate Limit (requests per minute)',
          },
          security: {
            title: 'Security Settings',
            description: 'Configure system security parameters',
            sessionTimeout: 'Session Timeout (minutes)',
            force2fa: 'Force Two-Factor Authentication',
    ...
    translation: {
      ...
      admin: {
        ...
        instructions: {
          ...
          noCategory: '未分类',
          noTemplate: '无',
          noInstructions: '未找到指令',
          confirmDelete: {
            title: '删除指令',
            message: '确定要删除这个指令吗？此操作无法撤销。',
            confirm: '删除',
            cancel: '取消',
          },
        },
        ...
        settings: {
          ...
          api: {
            title: 'API 设置',
            description: '配置 API 相关参数',
            openaiKey: 'OpenAI API Key',
            rateLimit: 'API 速率限制 (每分钟请求数)',
          },
          security: {
            title: '安全设置',
